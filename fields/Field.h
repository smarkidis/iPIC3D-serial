...
public:
  ...
  virtual void AddPerturbationRho(double deltaBoB, double kx, double ky, double kz, double Bx_mod, double By_mod, double Bz_mod, double ne_mod, double ne_phase, double ni_mod, double ni_phase, double B0, Grid *grid) = 0;
  /** add a perturbattion to the EM field */
  virtual void AddPerturbation(double deltaBoB, double kx, double ky, double kz, double Ex_mod, double Ex_phase, double Ey_mod, double Ey_phase, double Ez_mod, double Ez_phase, double Bx_mod, double Bx_phase, double By_mod, double By_phase, double Bz_mod, double Bz_phase, double B0, Grid *grid) = 0;
